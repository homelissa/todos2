...
var _todo_list_container = __webpack_require__(/*! ./components/todos/todo_list_container */ "./frontend/components/todos/todo_list_container.jsx");

var _todo_list_container2 = _interopRequireDefault(_todo_list_container);

var _index = __webpack_require__(/*! ./components/index */ "./frontend/components/index.jsx");
...
var _app = __webpack_require__(/*! ../app.jsx */ "./frontend/app.jsx");
...
var mSTP = function mSTP(state) {
  return {
    todos: (0, _selectors2.default)(state) // returns an array of todo objects
  };
};
...
exports.default = (0, _reactRedux.connect)(mSTP, mDTP)(_todo_list2.default);
